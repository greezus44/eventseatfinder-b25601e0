...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Seatly — Live seating charts for weddings & events" },
      ...
      { property: "og:title", content: "Seatly — Live seating charts" },
      { property: "og:description", content: "Beautiful, editable guest seating pages. No app. No passwords." },
