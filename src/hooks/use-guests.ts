...
export function useCreateGuest() {
  ...
  return useMutation({
    ...
    onSuccess: (created) => { queryClient.invalidateQueries({ queryKey: [GUESTS_KEY, created.event_id] }) },
  })
}
...
export function useUpdateGuest() {
  ...
  return useMutation({
    ...
    onSuccess: (updated) => { queryClient.invalidateQueries({ queryKey: [GUESTS_KEY, updated.event_id] }) },
  })
}
...
export function useBulkCreateGuests() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => { queryClient.invalidateQueries({ queryKey: [GUESTS_KEY, variables.event_id] }) },
  })
}
